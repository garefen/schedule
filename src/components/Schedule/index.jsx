    ...
    return (
        <div className="schedule">
            <div className="schedule__edit">
                <A href={'/edit/' + item._id} id="cta_button__edit" className="schedule__edit__button active">
            ...
            <div className="schedule__inner">
                <span className='schedule__inner__time'>{item.time}</span>
                <h1 className="schedule__inner__title">{item.title}</h1>
                <ul className="schedule__inner__bullets">
                    {item.bullets.map((value, key) => {
                        return (
